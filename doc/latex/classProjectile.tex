...
\index{Projectile@{Projectile}!parent@{parent}}
\index{parent@{parent}!Projectile@{Projectile}}
\subsubsection[{parent}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Render}$\ast$ {\bf Projectile::parent}}}
