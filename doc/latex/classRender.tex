...
\end{DoxyReturn}
\hypertarget{classRender_a8b8e53278c49bf3a65704b0913eaaefc}{
\index{Render@{Render}!isnotDead@{isnotDead}}
\index{isnotDead@{isnotDead}!Render@{Render}}
\subsubsection[{isnotDead}]{\setlength{\rightskip}{0pt plus 5cm}bool Render::isnotDead (
\begin{DoxyParamCaption}
\item[{{\bf Bug} $\ast$}]{tager}
\end{DoxyParamCaption}
)}}
\label{classRender_a8b8e53278c49bf3a65704b0913eaaefc}
Test si le pointeur donnée pointe toujours sur un insecte existant. return true si l'insecte existe. \hypertarget{classRender_ad88f7f01a7b9fafa756221707d590a78}{
