...
\index{Wasp@{Wasp}!Wasp@{Wasp}}
\index{Wasp@{Wasp}!Wasp@{Wasp}}
\subsubsection[{Wasp}]{\setlength{\rightskip}{0pt plus 5cm}Wasp::Wasp (
...
Appelle le constructeur de \hyperlink{classBug}{Bug} avec les paramètres spécifiques aux guêpes. 
\begin{DoxyParams}{Paramètres}
{\em x} & L'abscisse du départ des insectes. \\
\hline
{\em y} & L'ordonnée du départ des insectes. \\
\hline
{\em s} & La taille de la guêpe. \\
\hline
{\em start\_\-angle} & l'angle de départ des insectes. \\
\hline
\end{DoxyParams}
\hypertarget{classWasp_ac4b6b3f99b8a044cc2047144f0e44bb1}{
\index{Wasp@{Wasp}!$\sim$Wasp@{$\sim$Wasp}}
\index{$\sim$Wasp@{$\sim$Wasp}!Wasp@{Wasp}}
\subsubsection[{$\sim$Wasp}]{\setlength{\rightskip}{0pt plus 5cm}Wasp::$\sim$Wasp (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{classWasp_ac4b6b3f99b8a044cc2047144f0e44bb1}
...
\hline
\end{DoxyParams}
\hypertarget{classBug_abd2246d752d1088b35e01d57d176ce5f}{
\index{Wasp@{Wasp}!getAngle@{getAngle}}
\index{getAngle@{getAngle}!Wasp@{Wasp}}
\subsubsection[{getAngle}]{\setlength{\rightskip}{0pt plus 5cm}double Bug::getAngle (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inherited\mbox{]}}}}
\label{classBug_abd2246d752d1088b35e01d57d176ce5f}
Assesseur vers angle. \begin{DoxyReturn}{Renvoie}
L'ange de l'insecte. 
\end{DoxyReturn}
...
\end{DoxyReturn}
\hypertarget{classBug_a1c6d7743b87e9c4a85a58ea510c18526}{
\index{Wasp@{Wasp}!getPos@{getPos}}
\index{getPos@{getPos}!Wasp@{Wasp}}
\subsubsection[{getPos}]{\setlength{\rightskip}{0pt plus 5cm}QPointF Bug::getPos (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inherited\mbox{]}}}}
\label{classBug_a1c6d7743b87e9c4a85a58ea510c18526}
Assesseur vers pos. \begin{DoxyReturn}{Renvoie}
La position de l'insecte dans la scène. 
\end{DoxyReturn}
\hypertarget{classBug_ae29490347059f21518ff7162d0fbe9e5}{
\index{Wasp@{Wasp}!getSize@{getSize}}
\index{getSize@{getSize}!Wasp@{Wasp}}
\subsubsection[{getSize}]{\setlength{\rightskip}{0pt plus 5cm}double Bug::getSize (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}inherited\mbox{]}}}}
\label{classBug_ae29490347059f21518ff7162d0fbe9e5}
Assesseur vers size. \begin{DoxyReturn}{Renvoie}
...
\index{Wasp@{Wasp}!paint@{paint}}
\index{paint@{paint}!Wasp@{Wasp}}
\subsubsection[{paint}]{\setlength{\rightskip}{0pt plus 5cm}void Wasp::paint (
\begin{DoxyParamCaption}
...
Est appelé automatiquement par Qt pour dessiner la guêpe. \hypertarget{classBug_a587a36d3145c2b4dba6c689af22c65ac}{
...
\index{Wasp@{Wasp}!image@{image}}
\index{image@{image}!Wasp@{Wasp}}
\subsubsection[{image}]{\setlength{\rightskip}{0pt plus 5cm}QImage$\ast$ {\bf Wasp::image}\mbox{[}2\mbox{]}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
