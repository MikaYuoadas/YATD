...
Ce constructeur charge les images du moustique et appelle le constructeur parent de \hyperlink{classBug_a51f8bff5f42fcdf9e0503ddb5ef74fe5}{Bug()} avec les paramètres correspondants aux caractéristiques d'un moustique. 
...
\index{Mosquito@{Mosquito}!getAngle@{getAngle}}
\index{getAngle@{getAngle}!Mosquito@{Mosquito}}
...
\index{Mosquito@{Mosquito}!getPos@{getPos}}
\index{getPos@{getPos}!Mosquito@{Mosquito}}
...
\index{Mosquito@{Mosquito}!getSize@{getSize}}
\index{getSize@{getSize}!Mosquito@{Mosquito}}
